...
function DashboardCharts({ stats }) {
    ...
    // Amount by Status Bar Chart Data
    const amountData = [
      { 
        status: 'Pending', 
        amount: transactionStats.pendingAmount || 0,
        color: '#fbbf24'
      },
      { 
        status: 'Approved', 
        amount: transactionStats.approvedAmount || 0,
        color: '#22c55e'
      },
      { 
        status: 'Rejected', 
        amount: transactionStats.rejectedAmount || 0,
        color: '#ef4444'
      }
    ];
